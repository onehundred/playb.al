...
/////////////////////////////////////////////////////////////////				
             ...
             chart1.colors = ['#808080', '#808080', '#808080', '#808080', '#808080', '#808080', '#808080', '#808080'];
                 ...
                 $.ajax({
	        		...
	        		$().toastmessage('showErrorToast', "je hebt niet genoeg energie");
		        		...
		        		for(var i=1;i<count;i++){
		        			...
		        			$('#myModal').append('<p class="trainingPlayerName">'+spelers[i].naam +' is '+spelers[i].gestegen+' punten gestegen. nieuw totaal: '+ spelers[i].totaal+'</p>');
